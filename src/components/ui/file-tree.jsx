...
const TreeIndicator = forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    (<div
      ...
      ref={ref}
      className={cn(
        "h-full w-px bg-gray-500 absolute left-1.5 rtl:right-1.5 py-3 rounded-md hover:bg-gray-500 duration-300 ease-in-out",
        className
      )}
      {...props} />)
  );
    ...
    (<AccordionPrimitive.Item {...props} value={value} className="relative overflow-hidden h-full ">
      <AccordionPrimitive.Trigger
        className={cn(`flex items-center gap-1 text-sm rounded-md`, className, {
          "bg-gray-500 rounded-md": isSelect && isSelectable,
    ...
    (<AccordionPrimitive.Item value={value} className="relative">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          ...
          {
            "bg-gray-500": isSelected && isSelectable,
          },
