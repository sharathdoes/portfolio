...
function Highlights() {
  return (
    <div className="highlights-container mb-2">
      ...
      <li className="highlights-item mb-2">First Place in Webathon 3.0 Conducted by ACM VNRVJIET for Gigsy - platform for freelancers and clients.</li>
      <hr className="mb-2" />
        <li className="highlights-item mb-2">Was the technical lead of Designathon, a 24-hour national level hackathon at VNR VJIET .</li>
        <hr className="mb-2" />
        <li className="highlights-item mb-2">Proficient in React.js, Node.js, Express, Next.js , NeonDB, Prisma,  MongoDB, and exploring Langchain, NLP, RAG, and Vector databases like FAISS and chroma.</li>
        <hr className="mb-2" />
