...
function Xtension() {
  return (
    <div>
      ...
      <p className="mb-2">Xtension is a Chrome browser extension designed to enhance your experience on X/Twitter by intelligently filtering out unwanted or obscene content.</p>
